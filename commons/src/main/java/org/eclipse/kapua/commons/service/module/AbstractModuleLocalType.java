...
public abstract class AbstractModuleLocalType {

    public AbstractModuleLocalType() {
    }
    ...
    public ServiceReference get(Vertx vertx, ServiceDiscovery discovery, Record record, JsonObject configuration) {   
        ...
        Object service = this.getProvider().getInstance(className);
    ...
    protected abstract AbstractServiceProvider getProvider();
}
